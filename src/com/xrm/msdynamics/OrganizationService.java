...
public class OrganizationService {
    ...
    public NodeList Retrieve(String entityName, String id, String[] columns) throws IOException, MalformedURLException, SAXException, ParserConfigurationException, Exception {
        ...
        String request = "<s:Body>\n"
                ...
                + "                          <a:Id>" + StringEscapeUtils.escapeXml(id) + "</a:Id>\n"
                + "                          <a:LogicalName>" + StringEscapeUtils.escapeXml(entityName) + "</a:LogicalName>\n"
                + "                          <a:Name i:nil=\"true\" />\n"
                + "                        </b:value>\n"
                + "                      </a:KeyValuePairOfstringanyType>\n"
                + columnSet.ToXML()
    ...
    public Document RetrieveMultiple(String entityName, String[] columns, Criteria criteria) throws SAXException, ParserConfigurationException, Exception {
        ...
        String request = "<s:Body>\n"
                ...
                + "              <a:EntityName>" + StringEscapeUtils.escapeXml(entityName) + "</a:EntityName>\n"
                + "              <a:LinkEntities />\n"
                + "              <a:Orders />\n"
                + "              <a:PageInfo>\n"
                + "                <a:Count>0</a:Count>\n"
    ...
    public Account RetrieveAccountByName(String name) throws SAXException, ParserConfigurationException, Exception {
        String request = "  <s:Body>\n"
                ...
                + "                      <c:anyType i:type=\"d:string\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(name) + "</c:anyType>\n"
                + "                    </a:Values>\n"
                + "                  </a:ConditionExpression>\n"
                + "                </a:Conditions>\n"
    ...
    public Document RetrieveEntityByNameAndColumnString(String name, String column, String value) throws SAXException, ParserConfigurationException, Exception {
        String request = "  <s:Body>\n"
                ...
                + "                <a:Conditions>\n"
                + "                  <a:ConditionExpression>\n"
                + "                    <a:AttributeName>" + StringEscapeUtils.escapeXml(column) + "</a:AttributeName>\n"
                + "                    <a:Operator>Equal</a:Operator>\n"
                + "                    <a:Values xmlns:c=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">\n"
                ...
                + "              </a:Criteria>\n"
                + "              <a:Distinct>false</a:Distinct>\n"
                + "              <a:EntityName>" + StringEscapeUtils.escapeXml(name) + "</a:EntityName>\n"
                + "              <a:LinkEntities />\n"
                + "              <a:Orders />\n"
                + "              <a:PageInfo>\n"
                + "                <a:Count>0</a:Count>\n"
    ...
    public Document SearchActivyBySubjectAndRegardingObjectId(String entityName, String subject, String objectId) throws SAXException, ParserConfigurationException, Exception {
        String request = "  <s:Body>\n"
                ...
                + "                    <a:Operator>Equal</a:Operator>\n"
                + "                    <a:Values xmlns:c=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">\n"
                + "                      <c:anyType i:type=\"d:string\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(subject) + "</c:anyType>\n"
                + "                    </a:Values>\n"
                + "                  </a:ConditionExpression>\n"
                + "                  <a:ConditionExpression>\n"
                ...
                + "                    <a:Operator>Equal</a:Operator>\n"
                + "                    <a:Values xmlns:c=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">\n"
                + "                      <c:anyType i:type=\"d:guid\" xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/\">" + StringEscapeUtils.escapeXml(objectId) + "</c:anyType>\n"
                + "                    </a:Values>\n"
                + "                  </a:ConditionExpression>\n"
                + "                </a:Conditions>\n"
                + "                <a:FilterOperator>And</a:FilterOperator>\n"
    ...
    public Document CreateAppointment(String subject, String description, Date dateStart, Date dateEnd, String location, String organizer, String antendeeLogicalName, String antendee, int priority) throws SAXException, ParserConfigurationException, Exception {
        String request = "  <s:Body>\n"
                ...
                + "                <a:KeyValuePairOfstringanyType>\n"
                + "                  <c:key>subject</c:key>\n"
                + "                  <c:value i:type=\"d:string\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(subject) + "</c:value>\n"
                + "                </a:KeyValuePairOfstringanyType>\n"
                + "                <a:KeyValuePairOfstringanyType>\n"
                + "                  <c:key>description</c:key>\n"
                + "                  <c:value i:type=\"d:string\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(description) + "</c:value>\n"
                + "                </a:KeyValuePairOfstringanyType>\n"
                + "                <a:KeyValuePairOfstringanyType>\n"
                ...
                + "                  <c:value i:type=\"d:string\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(location) + "</c:value>\n"
                + "                </a:KeyValuePairOfstringanyType>\n"
                + "                <a:KeyValuePairOfstringanyType>\n"
                ...
                + "                            <c:key>partyid</c:key>\n"
                + "                            <c:value i:type=\"a:EntityReference\">\n"
                + "                              <a:Id>" + StringEscapeUtils.escapeXml(organizer) + "</a:Id>\n"
                ...
                + "                            <c:key>partyid</c:key>\n"
                + "                            <c:value i:type=\"a:EntityReference\">\n"
                + "                              <a:Id>" + StringEscapeUtils.escapeXml(antendee) + "</a:Id>\n"
                + "                              <a:LogicalName>" + StringEscapeUtils.escapeXml(antendeeLogicalName) + "</a:LogicalName>\n"
                + "                              <a:Name i:nil=\"true\" />\n"
                + "                            </c:value>\n"
                + "                          </a:KeyValuePairOfstringanyType>\n"
                + "                        </a:Attributes>\n"
    ...
    public String CreateEmailActivity(String entityName, String toId, String fromId, String subject, String body, int priority) throws SAXException, ParserConfigurationException, Exception, SAXException, SAXException, SAXException, SAXException, SAXException, SAXException, SAXException, ParserConfigurationException {
        String request = "  <s:Body>\n"
                ...
                + "                            <b:key>partyid</b:key>\n"
                + "                            <b:value i:type=\"a:EntityReference\">\n"
                + "                              <a:Id>" + StringEscapeUtils.escapeXml(toId) + "</a:Id>\n"
                + "                              <a:LogicalName>" + StringEscapeUtils.escapeXml(entityName) + "</a:LogicalName>\n"
                + "                              <a:Name i:nil=\"true\" />\n"
                + "                            </b:value>\n"
                + "                          </a:KeyValuePairOfstringanyType>\n"
                ...
                + "                            <b:key>partyid</b:key>\n"
                + "                            <b:value i:type=\"a:EntityReference\">\n"
                + "                              <a:Id>" + StringEscapeUtils.escapeXml(fromId) + "</a:Id>\n"
                + "                              <a:LogicalName>systemuser</a:LogicalName>\n"
                + "                              <a:Name i:nil=\"true\" />\n"
                + "                            </b:value>\n"
                + "                          </a:KeyValuePairOfstringanyType>\n"
    ...
    public String CreateEmailActivity(String entityName, String toId, String fromId, String subject, String body, int priority, Date timestamp) throws SAXException, ParserConfigurationException, Exception {
        ...
        String request = "<s:Body>\n"
                ...
                + "                <a:KeyValuePairOfstringanyType>\n"
                + "                  <b:key>subject</b:key>\n"
                + "                  <b:value i:type=\"c:string\" xmlns:c=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(subject) + "</b:value>\n"
                + "                </a:KeyValuePairOfstringanyType>\n"
                + "                <a:KeyValuePairOfstringanyType>\n"
                + "                  <b:key>description</b:key>\n"
                + "                  <b:value i:type=\"c:string\" xmlns:c=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(body) + "</b:value>\n"
                + "                </a:KeyValuePairOfstringanyType>\n"
                + "                <a:KeyValuePairOfstringanyType>\n"
                + "                  <b:key>directioncode</b:key>\n"
                + "                  <b:value i:type=\"c:boolean\" xmlns:c=\"http://www.w3.org/2001/XMLSchema\">true</b:value>\n"
    ...
    public ArrayList<SharePointDocument> RetrieveDocumentsByUserId(String userId) throws SAXException, ParserConfigurationException, Exception {
        String request = "  <s:Body>\n"
                ...
                + "                    <a:Operator>Equal</a:Operator>\n"
                + "                    <a:Values xmlns:c=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">\n"
                + "                      <c:anyType i:type=\"d:guid\" xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/\">" + StringEscapeUtils.escapeXml(userId) + "</c:anyType>\n"
                + "                    </a:Values>\n"
                + "                  </a:ConditionExpression>\n"
                + "                </a:Conditions>\n"
                + "                <a:FilterOperator>And</a:FilterOperator>\n"
    ...
    public boolean hasSolutionInstalled(String solutionName) throws SAXException, ParserConfigurationException, Exception {
        ...
        String request = "  <s:Body>\n"
                ...
                + "                    <a:Operator>Equal</a:Operator>\n"
                + "                    <a:Values xmlns:c=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">\n"
                + "                      <c:anyType i:type=\"d:string\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">" + StringEscapeUtils.escapeXml(solutionName) + "</c:anyType>\n"
                + "                    </a:Values>\n"
                + "                  </a:ConditionExpression>\n"
                + "                </a:Conditions>\n"
                + "                <a:FilterOperator>And</a:FilterOperator>\n"
