 ...
 * @author rguluarte
 */
public class LiveHiveAccount extends Account {
    ...
    public static String[] LiveHiveAccountColumns = new String[]{
        ID_COLUMN,
        NAME_COLUMN,
    ...
    public LiveHiveAccount(NodeList nodes) {
        super(nodes);
    }

    public LiveHiveAccount() {
        super();
    }

    @Override
    public String[] getDefaultColumns() {
        return LiveHiveAccountColumns;
    }
